...
Successivamente dobbiamo importare il file di dump del database col nome "datab matrimonio".

Quindi ora dopo aver fatto queste operazioni non resta che aprire la web app attraverso http://localhost/wedding-planner/ che ci indirizzerà alla homepage del progetto.

Per l'invio di email in locale far riferimento al txt corrispondente.
Per l'inizializzazione della fase di test far riferimento alla cartella tests.
